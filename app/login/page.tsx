      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="vijaya-card p-8 md:p-10 bg-white">
          ...
          <p className="text-gray-600 text-center mb-8">
            Continúa cultivando conocimiento
          </p>
          ...
          <div className="mt-8 space-y-4 text-center">
            <Link 
              ...
              className="block text-sm text-vijaya-olive hover:text-vijaya-green transition-colors font-medium"
            >
            ...
            <div className="pt-6 border-t border-gray-100">
              <p className="text-sm text-gray-600">
                ¿No tienes cuenta?{' '}
                <Link href="/register" className="text-vijaya-olive font-semibold hover:text-vijaya-green transition-colors">
                  Regístrate aquí
                </Link>
              </p>
            </div>
